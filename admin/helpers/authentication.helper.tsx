...
export const getBaseAuthenticationModes: (props: TGetBaseAuthenticationModeProps) => TInstanceAuthenticationModes[] = ({
  ...
  resolvedTheme,
}) => [
    {
      ...
      name: "Unique codes",
      description:
        "Log in or sign up for DPM using codes sent via email. You need to have set up SMTP to use this method.",
    ...
    },
    {
      key: "google",
      name: "Google",
      description: "Allow members to log in or sign up for DPM with their Google accounts.",
    ...
    },
    {
      key: "github",
      name: "GitHub",
      description: "Allow members to log in or sign up for DPM with their GitHub accounts.",
      icon: (
        <Image
